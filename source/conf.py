...
project = '96Boards Specifications'
...
latex_documents = [
    (master_doc, '98bspec.tex', project, author, 'manual'),
]
...
man_pages = [
    (master_doc, '96bspec', project, [author], 1)
]
...
texinfo_documents = [
    (master_doc, '96Boards_Specifications', project, author, '96Boards_Specifications',
